...
export const RightSide = () => {
  return (
    <div className=" w-full flex flex-col shadow-md gap-6 p-2">
      <div className=" h-[250px] w-full shadow-md p-2">
        <h2 className=" font-bold text-center">Ads</h2>
        <img
      ...
      <div className=" h-[200px] w-full shadow-md p-2">
        <h2 className=" font-bold text-center">Treding News</h2>
        <img
