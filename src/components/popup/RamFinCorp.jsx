...
const popupData = {
  ...
  mobileImage: "/ramfinpopup/mobile.webp",
  link: "https://offer.mvmtracking.com/api/clicks?campaign_id=804&pub_id=59&originalClick={}&sub1={your_sub}",
};

export default function RamFinCorp() {
