...
const walkinData1 = [
  ...
  return (
    <div className=' px-4 max-w-[1000px] mx-auto flex flex-col gap-[40px]'>
        ...
        <h1 className='text-[25px] md:text-[35px] lg:text-[48px] text-black font-bold text-left'>Federal Bank Associate Officer Recruitment 2025 - Apply Online</h1>
        <div class="space-y-2 text-gray-800 text-sm sm:text-base">
  <p><span class="text-[18px] font-semibold">Job Role:</span> Federal Bank Associate Officer </p>
...
<div class=" text-gray-800 space-y-6 text-sm sm:text-base">
  ...
  <div>
    <h2 className='font-bold text-black'>Federal Bank Recruitment 2025</h2>
    <p>The Federal Bank Recruitment 2025 for posts of Associate Officer. Candidates with Any Graduate, Diploma Can Apply Online. The online application opens on 10-06-2025, and closes on 22-06-2025. The candidate shall apply online through Federal Bank website, federalbank.co.in.</p>
  </div>
  ...
  <div>
    <h2 class="font-semibold text-lg mb-2">Federal Bank Recruitment 2025 Important Dates</h2>
    <ul class="list-disc pl-5 space-y-1">
      <li>Starting Date for Apply Online: 10-06-2025</li>
      <li>Last Date for Apply Online: 22-06-2025</li>
      <li>Proposed Date of Centre based Online Aptitude Test: 06-07-2025</li>
  ...
  <div>
    ...
    <ul class="list-disc pl-5 space-y-1">
      <li>The cost to company per annum would be a minimum of ‹4.59 Lakh and maximum of 26.19 Lakh depending upon the performance of the employee, place of posting and other factors.</li>
      <li>Selected candidates will be covered under the National Pension Scheme (NPS) and will also be eligible for other benefits like gratuity, loans on concessional interest rate, medical insurance coverage for self & dependents etc.</li>
      <li>Candidates selected for the post of Associate Officer (Sales) can look forward to a rewarding career, with a well defined growth path and opportunities for fast - track career progression, based on performance.</li>
      {/* <li>A supportive team culture that values innovation and customer excellence.</li> */}
    </ul>
  </div>
</div>
