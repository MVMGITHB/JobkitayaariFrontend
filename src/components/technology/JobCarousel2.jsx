...
const JobCarousel2 = ({ jobs, title, color, data }) => {
  ...
  return (
    <div className="relative flex justify-center py-4 overflow-hidden">
      <div className="w-full max-w-[90%]">
        ...
        {/* Title */}
        <h2 className={`text-[16px] lg:text-2xl font-bold text-center p-2 lg:p-0 px-4 lg:px-6 mb-2 rounded-2xl bg-blue-400 text-white`}>
          {title}
        </h2>
